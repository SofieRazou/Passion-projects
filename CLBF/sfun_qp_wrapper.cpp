 ...
 *
 *         double y1 = solve_qp_wrapper(double u1, double u2)
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C++ source code generated on : 15-Mar-2026 18:23:18
 *
...
/**
     ...
     def.IncPaths = {'/Users/sofia/Desktop/projects_4_exercise/simulink_projects', '/opt/homebrew/Cellar/eigen/5.0.1/include/eigen3'};
...
#define S_FUNCTION_NAME  sfun_qp_wrapper
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "solve_qp_wrapper", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "solve_qp_wrapper_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
