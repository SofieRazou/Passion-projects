...
class SignalPlotPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.current_1_value_label = QLabel("AO_ch8: --")
        self.current_2_value_label = QLabel("AO_ch16: --")
        ...
        plot_layout.addWidget(self.current_plot, 2, 0)
    ...
    def add_sample(
        ...
        self.angle_values.append(math.degrees(angle_rad))
        ...
        self.angle_value_label.setText(
            f"Angle: {math.degrees(angle_rad):.3f}°"
        )
