...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # FIX 1: Create the line object ONCE, attached to self.line
        ...
        # Dynamic data update configuration
        self.timer = QTimer()
    ...
    def update_plot(self):
        ...
        # FIX 2: Change self.plot_graph.line to self.line
        self.line.setData(self.time, self.torque)        
