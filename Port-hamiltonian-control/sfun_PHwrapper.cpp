 ...
 *
 *         double y1 = PH_wrapper(double u1, double u2)
 *
 *    Simulink version           : 25.2 (R2025b) 28-Jul-2025
 *    C++ source code generated on : 04-Apr-2026 16:06:40
 *
...
/**
     ...
     def.IncPaths = {'/Users/sofia/Desktop', '/opt/homebrew/Cellar/eigen/5.0.1/include/eigen3'};
...
#define S_FUNCTION_NAME  sfun_PHwrapper
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "PH_wrapper", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "PH_wrapper_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
